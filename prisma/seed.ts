...
async function main() {
  ...
  const listing1 = await prisma.listing.create({
    data: {
      ...
      area: 'Ikeja',
      state: 'Lagos',
      price: new Prisma.Decimal(1200000), // ₦1.2M/year
      pricePeriod: 'year',
      cautionDeposit: new Prisma.Decimal(600000),
      serviceCharge: new Prisma.Decimal(150000),
      bedrooms: 2,
      bathrooms: 2,
      toilets: 3,
      sizeSqm: new Prisma.Decimal(85),
      floorLevel: 3,
      furnished: false,
      parkingSpaces: 1,
  ...
  const listing2 = await prisma.listing.create({
    data: {
      ...
      area: 'Lekki',
      state: 'Lagos',
      price: new Prisma.Decimal(85000000), // ₦85M
      pricePeriod: 'total',
      bedrooms: 4,
      bathrooms: 5,
      toilets: 6,
      sizeSqm: new Prisma.Decimal(350),
      furnished: true,
      parkingSpaces: 3,
  ...
  const listing3 = await prisma.listing.create({
    data: {
      ...
      state: 'Lagos',
      price: new Prisma.Decimal(4500000), // ₦4.5M/year
      pricePeriod: 'year',
      cautionDeposit: new Prisma.Decimal(2250000),
      serviceCharge: new Prisma.Decimal(800000),
      bedrooms: 3,
      bathrooms: 4,
      toilets: 4,
      sizeSqm: new Prisma.Decimal(180),
      floorLevel: 12,
      furnished: true,
      parkingSpaces: 2,
  ...
  const listing4 = await prisma.listing.create({
    data: {
      ...
      area: 'Ibeju-Lekki',
      state: 'Lagos',
      price: new Prisma.Decimal(120000000), // ₦120M
      pricePeriod: 'total',
      sizeSqm: new Prisma.Decimal(2000),
  ...
  const listing5 = await prisma.listing.create({
    data: {
      ...
      area: 'Lekki',
      state: 'Lagos',
      price: new Prisma.Decimal(35000), // ₦35k/night
      pricePeriod: 'night',
      bedrooms: 1,
      bathrooms: 1,
      toilets: 1,
      sizeSqm: new Prisma.Decimal(45),
      floorLevel: 2,
      furnished: true,
      parkingSpaces: 1,
  ...
  const listing6 = await prisma.listing.create({
    data: {
      ...
      area: 'Yaba',
      state: 'Lagos',
      price: new Prisma.Decimal(300000), // ₦300k/year
      pricePeriod: 'year',
      cautionDeposit: new Prisma.Decimal(150000),
      bedrooms: 1,
      bathrooms: 1,
      toilets: 1,
      sizeSqm: new Prisma.Decimal(12),
      furnished: false,
      parkingSpaces: 0,
  ...
  const listing7 = await prisma.listing.create({
    data: {
      ...
      area: 'Ikeja',
      state: 'Lagos',
      price: new Prisma.Decimal(12000000), // ₦12M/year
      pricePeriod: 'year',
      serviceCharge: new Prisma.Decimal(2000000),
  ...
  const listing8 = await prisma.listing.create({
    data: {
      ...
      area: 'Surulere',
      state: 'Lagos',
      price: new Prisma.Decimal(1500000), // ₦1.5M/year
      pricePeriod: 'year',
      cautionDeposit: new Prisma.Decimal(750000),
      sizeSqm: new Prisma.Decimal(65),
      floorLevel: 0,
      furnished: false,
      parkingSpaces: 2,
  ...
  const listing9 = await prisma.listing.create({
    data: {
      ...
      area: 'Apapa',
      state: 'Lagos',
      price: new Prisma.Decimal(18000000), // ₦18M/year
      pricePeriod: 'year',
      serviceCharge: new Prisma.Decimal(1500000),
      sizeSqm: new Prisma.Decimal(2000),
      parkingSpaces: 20,
  ...
  const listing10 = await prisma.listing.create({
    data: {
      ...
      area: 'Ikoyi',
      state: 'Lagos',
      price: new Prisma.Decimal(250000000), // ₦250M
      pricePeriod: 'total',
      bedrooms: 5,
      bathrooms: 6,
      toilets: 7,
      sizeSqm: new Prisma.Decimal(600),
      furnished: true,
      parkingSpaces: 5,
  ...
  const agreement1 = await prisma.agreement.create({
    data: {
      ...
      rentAmount: new Prisma.Decimal(4500000),
      rentPeriod: 'yearly',
      cautionDeposit: new Prisma.Decimal(2250000),
      serviceCharge: new Prisma.Decimal(800000),
      noticePeriodDays: 60,
  ...
  const agreement2 = await prisma.agreement.create({
    data: {
      ...
      rentAmount: new Prisma.Decimal(1200000),
      rentPeriod: 'yearly',
      cautionDeposit: new Prisma.Decimal(600000),
      serviceCharge: new Prisma.Decimal(150000),
      noticePeriodDays: 30,
