          ...
          <section className="relative bg-primary overflow-hidden py-20 px-4 md:px-8">
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-center">
              ...
              <div className="relative max-w-2xl mx-auto group">
                <span className="material-symbols-outlined absolute left-6 top-1/2 -translate-y-1/2 text-primary-fixed-dim text-2xl group-focus-within:text-secondary transition-colors">
                  search
                </span>
                <input
                  type="text"
              ...
              {roles.map((role) => (
                ...
                >
                  ...
                  <ul className="space-y-3 mt-auto">
                    {role.label === 'Tenants' && (
                      <>
                        <li><Link href="#" className="text-primary text-sm font-medium flex items-center gap-2">Rentals <span className="material-symbols-outlined text-sm">chevron_right</span></Link></li>
                        <li><Link href="#" className="text-primary text-sm font-medium flex items-center gap-2">Secure Payments <span className="material-symbols-outlined text-sm">chevron_right</span></Link></li>
                      </>
                    )}
                    {role.label === 'Landlords' && (
                      <>
                        <li><Link href="#" className="text-primary text-sm font-medium flex items-center gap-2">Listing Guide <span className="material-symbols-outlined text-sm">chevron_right</span></Link></li>
                        <li><Link href="#" className="text-primary text-sm font-medium flex items-center gap-2">Verification <span className="material-symbols-outlined text-sm">chevron_right</span></Link></li>
                      </>
                    )}
                    {role.label === 'Agents' && (
                      <>
                        <li><Link href="#" className="text-primary text-sm font-medium flex items-center gap-2">Agent Tools <span className="material-symbols-outlined text-sm">chevron_right</span></Link></li>
                        <li><Link href="#" className="text-primary text-sm font-medium flex items-center gap-2">Lead Gen <span className="material-symbols-outlined text-sm">chevron_right</span></Link></li>
                      </>
                    )}
                ...
                <div className="space-y-4">
                  {articles.map((article, i) => (
                    <div key={i} className="bg-white p-6 rounded-xl border border-outline-variant flex items-center gap-6 group hover:bg-surface-bright transition-colors cursor-pointer">
                      ...
                      <span className="material-symbols-outlined text-primary-fixed-dim hidden sm:block">open_in_new</span>
                    </div>
                  ))}
                </div>
              </div>
