    ...
    <DashboardShell navigation={ADMIN_NAVIGATION}>
      <section className="space-y-6">
        ...
        <div className="rounded-lg border border-border bg-white p-12 text-center shadow-card">
          ...
          <h3 className="text-lg font-medium text-gray-900">No payment data yet</h3>
          <p className="mt-1 text-gray-500">Payment analytics and escrow controls will appear here.</p>
        </div>
      </section>
    </DashboardShell>
  );
