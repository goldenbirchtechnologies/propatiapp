    ...
    return (
      <DashboardShell navigation={ADMIN_NAVIGATION}>
        <section className="space-y-6">
          ...
          <p className="text-muted-foreground">Track and analyze platform revenue and fees.</p>
    ...
    <DashboardShell navigation={ADMIN_NAVIGATION}>
      <section className="space-y-6">
        ...
        <div className="rounded-lg border border-border bg-surface-container-lowest p-12 text-center shadow-card">
          ...
          <h3 className="text-lg font-medium text-primary">No revenue data yet</h3>
          <p className="mt-1 text-on-surface-variant">Revenue analytics will appear here.</p>
        </div>
      </section>
    </DashboardShell>
  );
