              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between p-4 bg-surface-container-low rounded-lg border border-outline-variant/20">
                  <div className="flex gap-4">
                    <span className="lucide text-on-surface-variant" data-icon="key">key</span>
                    <div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="border border-outline-variant rounded-lg p-5">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-surface-container-high flex items-center justify-center">
                        <span className="lucide text-on-surface text-lg" data-icon="integration_instructions">integration_instructions</span>
                      </div>
                  ...
                  <div className="space-y-3">
                    <div className="relative">
                      ...
                      />
                      <button className="absolute right-3 top-1/2 -translate-y-1/2 lucide text-on-surface-variant hover:text-primary transition-colors" aria-label="Copy" data-icon="content_copy">
                        content_copy
                      </button>
                    </div>
                ...
                <div className="border border-outline-variant rounded-lg p-5">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-surface-container-high flex items-center justify-center">
                        <span className="lucide text-on-surface text-lg" data-icon="webhook">webhook</span>
                      </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between text-xs p-2 bg-surface rounded">
                      ...
                      <span className="lucide text-xs text-on-surface-variant cursor-pointer" data-icon="edit">edit</span>
                    </div>
                    <div className="flex items-center justify-between text-xs p-2 bg-surface rounded">
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-surface-container-high flex items-center justify-center">
                    <span className="lucide text-primary" data-icon="map">map</span>
                  </div>
                  <div>
