...
export default function GlobalSettingsClient() {
  return (
    <div className="dashboard-content-area">
      ...
      {/* TOP APP BAR */}
      <div className="flex items-center w-full px-margin-desktop h-16 sticky top-0 z-40 bg-surface border-b border-[#262626] mb-lg">
        <div className="flex items-center gap-md">
          <h2 className="font-headline-sm text-headline-sm font-black text-white">Admin Console</h2>
        </div>
      </div>
      ...
      <div className="p-gutter space-y-lg">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-md mb-xl">
          <div>
            ...
            <p className="text-body-md text-neutral-400">Platform-wide parameters, verification rules, and security posture.</p>
          </div>
          <div className="flex gap-sm">
            <button className="flex items-center gap-sm px-lg h-11 border border-[#262626] text-white font-label-md rounded-xl hover:bg-obsidian-800-lowest transition-all">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-lg mb-lg">
          ...
          <div className="lg:col-span-3">
            <nav className="space-y-1 sticky top-24">
              <a className="flex items-center gap-sm px-md py-sm text-neutral-400 hover:bg-obsidian-800-lowest rounded-lg transition-colors font-label-md" href="#">
          ...
          <div className="lg:col-span-9 space-y-lg">
            ...
            <section className="bg-obsidian-800/30 p-lg rounded-xl border border-[#262626] shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-body-sm text-neutral-400">Core business logic and fee configuration.</p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-lg">
                <div className="space-y-6">
                  <div>
                    <label className="block font-label-md text-label-md text-neutral-400 mb-2">
                      Escrow Hold Period
                    </label>
                    <div className="relative">
                      <input
                        className="w-full h-[44px] rounded-lg border-[#262626] border px-4 focus:ring-2 focus:ring-primary/10 focus:border-primary outline-none font-semibold"
                        type="number"
                        defaultValue={14}
                      />
                      <span className="absolute right-4 top-1/2 -translate-y-1/2 text-neutral-400 font-label-md">DAYS</span>
                    </div>
                  ...
                  <div>
                    <label className="block font-label-md text-label-md text-neutral-400 mb-2">Rental Service Fee</label>
                    <div className="relative">
                      <input
                        className="w-full h-[44px] rounded-lg border-[#262626] border px-4 focus:ring-2 focus:ring-primary/10 focus:border-primary outline-none font-semibold"
                        type="number"
                  ...
                  <div>
                    ...
                    <select className="w-full h-[44px] rounded-lg border-[#262626] border px-4 focus:ring-2 focus:ring-primary/10 focus:border-primary outline-none font-semibold appearance-none bg-no-repeat bg-[right_1rem_center]">
            ...
            <section className="bg-obsidian-800/30 p-8 rounded-lg border border-[#262626]/30 shadow-sm relative overflow-hidden" id="verification">
              ...
              <div className="grid grid-cols-3 gap-6">
                {/* Rule Card */}
                <div className="p-4 bg-surface rounded-lg border border-[#262626]/50">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      className="w-16 h-8 text-center rounded border-[#262626] border text-sm font-bold"
                      type="number"
                      defaultValue={30}
                    />
            ...
            <section className="bg-obsidian-800/30 p-8 rounded-lg border border-[#262626]/30 shadow-sm" id="security">
              <div className="flex items-center gap-3 mb-8">
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between p-4 bg-obsidian-800/30 rounded-lg border border-[#262626]/20">
                  <div className="flex gap-4">
                    <span className="lucide text-neutral-400" data-icon="key">key</span>
                    <div>
                ...
                <div className="grid grid-cols-12 gap-6">
                  <div className="col-span-8">
                    ...
                    <textarea
                      className="w-full rounded-lg border-[#262626] border p-4 font-label-md text-label-md focus:ring-2 focus:ring-primary/10 focus:border-primary outline-none"
            ...
            <section className="bg-obsidian-800/30 p-8 rounded-lg border border-[#262626]/30 shadow-sm" id="notifications">
              <div className="flex items-center gap-3 mb-8">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="border border-[#262626] rounded-lg p-5">
                  ...
                  <div className="space-y-3">
                    <div className="relative">
                      <input
                        className="w-full bg-surface text-xs font-label-md p-3 border border-[#262626]/50 rounded pr-10"
                        readOnly={true}
                        type="password"
                        defaultValue="sk_tes...p7dc"
                      />
                      <button className="absolute right-3 top-1/2 -translate-y-1/2 lucide text-neutral-400 hover:text-white transition-colors" aria-label="Copy" data-icon="content_copy">
                        content_copy
                      </button>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-[10px] text-neutral-400 font-medium">Last Ping: 2m ago</span>
                ...
                <div className="border border-[#262626] rounded-lg p-5">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="px-2 py-0.5 bg-outline-variant/20 text-neutral-400 text-[10px] font-bold rounded uppercase">
                      7 Active
                    </span>
                  </div>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between text-xs p-2 bg-surface rounded">
                      ...
                      <span className="lucide text-xs text-neutral-400 cursor-pointer" data-icon="edit">edit</span>
                    </div>
                    <div className="flex items-center justify-between text-xs p-2 bg-surface rounded">
                      <span className="font-medium text-white">listing.flagged</span>
                      <span className="lucide text-xs text-neutral-400 cursor-pointer" data-icon="edit">edit</span>
                    </div>
                    <button className="w-full py-1 text-[10px] font-bold text-center border border-dashed border-[#262626] rounded hover:bg-obsidian-800-lowest transition-colors">
                      Add Webhook Secret
                    </button>
                  </div>
                </div>
            ...
            <section className="bg-obsidian-800/30 p-8 rounded-lg border border-[#262626]/30 shadow-sm">
              <div className="flex items-center justify-between mb-6">
                ...
                <button className="flex items-center gap-2 px-4 py-2 bg-obsidian-800/30 rounded-lg text-body-sm font-semibold hover:bg-obsidian-800-high transition-all">
              ...
              <div className="w-full h-64 bg-zinc-900 rounded-lg overflow-hidden relative">
                ...
                <div className="absolute bottom-4 left-4 flex gap-2">
                  <span className="px-2 py-1 bg-obsidian-800/30/90 backdrop-blur-sm rounded text-[10px] font-bold shadow-sm">LAGOS: INTEGRATED</span>
                  <span className="px-2 py-1 bg-obsidian-800/30/90 backdrop-blur-sm rounded text-[10px] font-bold shadow-sm">ABUJA: PENDING</span>
                </div>
              </div>
            </section>
          </div>
