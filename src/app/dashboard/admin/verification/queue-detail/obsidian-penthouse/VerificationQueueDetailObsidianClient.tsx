    ...
    <div className="w-full p-6 space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="space-y-1">
          <div className="flex items-center gap-1 text-sm text-zinc-500 font-label-sm">
            ...
            <AppIcon name="chevron_right" className="lucide" />
            <span className="text-white">#EV-98231</span>
          </div>
          <h2 className="text-headline-lg text-white font-headline-lg">The Obsidian Penthouse</h2>
          <div className="flex items-center gap-2">
            ...
            <span className="rounded-full bg-zinc-800 px-3 py-1 text-xs font-label-sm text-zinc-500">
              Created 2h ago
            </span>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <button className="rounded-lg border border-white/[0.08] px-5 py-2 font-bold text-white hover:bg-zinc-900 transition-colors">Request Info</button>
          <button className="rounded-lg bg-error px-5 py-2 font-bold text-on-error hover:opacity-90 transition-opacity">Reject</button>
          <button className="rounded-lg bg-primary-container px-5 py-2 font-bold text-on-primary-container shadow-none hover:-translate-y-0.5 transition-all">Approve & Certify</button>
        </div>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <div className="lg:col-span-4 rounded-lg border border-white/[0.08] bg-surface p-6 shadow-none space-y-6">
          <h3 className="font-headline-sm text-white">Verification Pipeline</h3>
              ...
              return (
                <div key={step.label} className="flex gap-4 relative">
                  ...
                  <div className="flex-1 space-y-1">
                    <p className="font-label-sm text-white">{step.label}</p>
                    <p className="text-sm text-zinc-500">{step.sub}</p>
                  </div>
                </div>
              );
            })}
        ...
        <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="rounded-lg border border-white/[0.08] bg-zinc-950/50 p-6 space-y-4">
            <div className="flex items-center justify-between">
              <h4 className="font-label-sm uppercase tracking-wider text-zinc-500">Property Owner</h4>
              <span className="rounded bg-on-tertiary-container/10 px-2 py-0.5 text-xs font-label-sm text-[#00ff66]">MATCHED 98%</span>
            </div>
            <div className="flex items-center gap-4">
              <img alt="Owner avatar" className="h-12 w-12 rounded-full border border-white/[0.08] object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDRtVkTaJtRyCVW7YClt5jsc2v2_klnwX2OEojt3Ht0JZoh9tP55l32XVouzrCafjRxTqn0gXWoLQlMwZ7dUOMRQqvfPbBGwj5C9ADSl4K9W5PO0CLYKtPZOeCjg0c64x6OB0Z-1n8t1vVKyUqFNBoA9xJ7bu9kOue7rsijLpShIHReVxnkQXuLs4vtzyIYUV2t9Bd33yaqmh69JV0dYYiD1Y__xfrysY3JM1pZ8SSp_PFIT4oEmtJcJNE1tuX5MadK9GpxIFq6ABM" />
              <div>
                <p className="font-headline-sm text-white">Emeka Adeyemi</p>
                <p className="text-sm text-zinc-500">Verified BVN: 221****092</p>
              </div>
            </div>
          </div>

          <div className="rounded-lg border border-white/[0.08] bg-zinc-950/50 p-6 space-y-3">
            <h4 className="font-label-sm uppercase tracking-wider text-zinc-500">Location Signature</h4>
            <div className="space-y-1">
              <p className="font-headline-sm text-white">Banana Island, Ikoyi</p>
          ...
          <div className="md:col-span-2 rounded-lg border border-white/[0.08] bg-zinc-950/50 p-6 space-y-4">
            <h4 className="font-headline-sm text-white">Legal Documentation</h4>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="overflow-hidden rounded-lg border border-white/[0.08] hover:border-white transition-colors">
              ...
              <div className="flex cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-white/[0.08] h-32 hover:bg-zinc-900 transition-colors">
                <AppIcon name="add_circle" className="lucide" />
                <p className="mt-2 text-xs font-label-sm text-zinc-500">Add Document</p>
              </div>
            </div>
          </div>
        </div>

        <div className="lg:col-span-12 rounded-lg border border-white/[0.08] bg-surface p-6 shadow-none space-y-6">
          <div className="flex items-center justify-between">
            <h3 className="font-headline-sm text-white">Physical Inspection Report</h3>
            <button className="flex items-center gap-1 text-sm font-label-sm text-secondary">
              View Full Report <AppIcon name="open_in_new" className="lucide" />
            </button>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-2">
              <p className="text-xs uppercase tracking-widest text-zinc-500 font-label-sm">Inspector Notes</p>
            ...
            <div className="space-y-2">
              <p className="text-xs uppercase tracking-widest text-zinc-500 font-label-sm">Utility Verification</p>
            ...
            <div className="space-y-2">
              <p className="text-xs uppercase tracking-widest text-zinc-500 font-label-sm">Risk Assessment</p>
              <div className="rounded-r-lg border-l-4 border-on-tertiary-container bg-on-tertiary-container/5 p-4">
                <p className="font-headline-sm text-[#00ff66] text-white">LOW RISK</p>
                <p className="text-sm opacity-80 text-[#00ff66]">9.5/10 Security Score</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-7 rounded-lg bg-primary-container p-6 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-4">
            <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full verification-badge-shimmer">
              <span className="lucide text-white text-3xl" style={{ fontVariationSettings: "'FILL' 1" }}>verified</span>
            </div>
        ...
        <div className="lg:col-span-5 rounded-lg border border-white/[0.08] bg-surface p-6 shadow-none space-y-4">
          <h3 className="font-headline-sm text-white">Audit Log</h3>
          <div className="max-h-[320px] space-y-4 overflow-y-auto pr-2">
            {[['System', 'automatically flagged location discrepancy', 'history', 'MAY 24, 09:12 AM'], ['Admin Sarah', 'manually resolved location issue', 'edit', 'MAY 24, 10:45 AM'], ['Inspector Funke', 'uploaded 12 inspection photos', 'image', 'MAY 24, 02:30 PM'], ['Managing Partner', 'pending final review', 'priority_high', 'JUST NOW']].map(([who, what, icon, time]) => (
              <div key={time} className="flex gap-4 border-b border-white/[0.08] pb-4 last:border-0">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] font-label-sm text-zinc-500">{time}</p>
                </div>
              </div>
            ))}
          </div>
          <button className="w-full rounded-lg border border-white/[0.08] py-2 font-bold text-sm hover:bg-zinc-900 transition-colors">Add Admin Note</button>
        </div>
      </div>

      <div className="h-20 md:hidden"></div>
      <nav className="md:hidden fixed inset-x-0 bottom-0 z-50 flex justify-around border-t border-white/[0.08] bg-surface py-3">
        <a className="flex flex-col items-center gap-1 text-zinc-500" href="#"><AppIcon name="dashboard" className="lucide" /><span className="text-[10px] font-label-sm">Home</span></a>
        <a className="flex flex-col items-center gap-1 text-white font-bold" href="#"><span className="lucide" style={{ fontVariationSettings: "'FILL' 1" }}>verified_user</span><span className="text-[10px] font-label-sm">Queue</span></a>
        <a className="flex flex-col items-center gap-1 text-zinc-500" href="#"><AppIcon name="domain" className="lucide" /><span className="text-[10px] font-label-sm">Units</span></a>
        <a className="flex flex-col items-center gap-1 text-zinc-500" href="#"><AppIcon name="settings" className="lucide" /><span className="text-[10px] font-label-sm">Settings</span></a>
      </nav>
    </div>
  );
}
