    ...
    <div className="mx-auto max-w-7xl w-full p-6 space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="space-y-1">
          <div className="flex items-center gap-1 text-sm text-neutral-400 font-label-sm">
        ...
        <div className="flex items-center gap-2">
          <button className="rounded-lg border border-[#262626] px-5 py-2 font-bold text-white hover:bg-obsidian-800-lowest transition-colors">Request Info</button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <div className="lg:col-span-4 rounded-lg border border-[#262626] bg-surface p-6 shadow-sm space-y-6">
              ...
              return (
                <div key={step.label} className="flex gap-4 relative">
                  ...
                  <div className="flex-1 space-y-1">
                    <p className="font-label-md text-white">{step.label}</p>
                    <p className="text-sm text-neutral-400">{step.sub}</p>
                  </div>
                </div>
              );
            })}
        ...
        <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="rounded-lg border border-[#262626] bg-obsidian-800/30 p-6 space-y-4">
            <div className="flex items-center justify-between">
              <h4 className="font-label-md uppercase tracking-wider text-neutral-400">Property Owner</h4>
              <span className="rounded bg-on-tertiary-container/10 px-2 py-0.5 text-xs font-label-sm text-[#00ff66]">MATCHED 98%</span>
            </div>
            <div className="flex items-center gap-4">
              <img alt="Owner avatar" className="h-12 w-12 rounded-full border border-[#262626] object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDRtVkTaJtRyCVW7YClt5jsc2v2_klnwX2OEojt3Ht0JZoh9tP55l32XVouzrCafjRxTqn0gXWoLQlMwZ7dUOMRQqvfPbBGwj5C9ADSl4K9W5PO0CLYKtPZOeCjg0c64x6OB0Z-1n8t1vVKyUqFNBoA9xJ7bu9kOue7rsijLpShIHReVxnkQXuLs4vtzyIYUV2t9Bd33yaqmh69JV0dYYiD1Y__xfrysY3JM1pZ8SSp_PFIT4oEmtJcJNE1tuX5MadK9GpxIFq6ABM" />
              <div>
                <p className="font-headline-sm text-white">Emeka Adeyemi</p>
                <p className="text-sm text-neutral-400">Verified BVN: 221****092</p>
              </div>
            </div>
          </div>

          <div className="rounded-lg border border-[#262626] bg-obsidian-800/30 p-6 space-y-3">
            <h4 className="font-label-md uppercase tracking-wider text-neutral-400">Location Signature</h4>
            <div className="space-y-1">
          ...
          <div className="md:col-span-2 rounded-lg border border-[#262626] bg-obsidian-800/30 p-6 space-y-4">
            <h4 className="font-headline-sm text-white">Legal Documentation</h4>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="overflow-hidden rounded-lg border border-[#262626] hover:border-white transition-colors">
              ...
              <div className="flex cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-[#262626] h-32 hover:bg-obsidian-800-lowest transition-colors">
                <AppIcon name="add_circle" className="lucide" />
                <p className="mt-2 text-xs font-label-sm text-neutral-400">Add Document</p>
              </div>
            </div>
          </div>
        </div>

        <div className="lg:col-span-12 rounded-lg border border-[#262626] bg-surface p-6 shadow-sm space-y-6">
          <div className="flex items-center justify-between">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-2">
              <p className="text-xs uppercase tracking-widest text-neutral-400 font-label-sm">Inspector Notes</p>
            ...
            <div className="space-y-2">
              <p className="text-xs uppercase tracking-widest text-neutral-400 font-label-sm">Utility Verification</p>
            ...
            <div className="space-y-2">
              <p className="text-xs uppercase tracking-widest text-neutral-400 font-label-sm">Risk Assessment</p>
              <div className="rounded-r-lg border-l-4 border-on-tertiary-container bg-on-tertiary-container/5 p-4">
                <p className="font-headline-sm text-[#00ff66] text-headline-sm">LOW RISK</p>
        ...
        <div className="lg:col-span-5 rounded-lg border border-[#262626] bg-surface p-6 shadow-sm space-y-4">
            ...
            {[['System', 'automatically flagged location discrepancy', 'history', 'MAY 24, 09:12 AM'], ['Admin Sarah', 'manually resolved location issue', 'edit', 'MAY 24, 10:45 AM'], ['Inspector Funke', 'uploaded 12 inspection photos', 'image', 'MAY 24, 02:30 PM'], ['Managing Partner', 'pending final review', 'priority_high', 'JUST NOW']].map(([who, what, icon, time]) => (
              <div key={time} className="flex gap-4 border-b border-[#262626] pb-4 last:border-0">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] font-label-sm text-neutral-400">{time}</p>
                </div>
              </div>
            ))}
          </div>
          <button className="w-full rounded-lg border border-[#262626] py-2 font-bold text-sm hover:bg-obsidian-800-lowest transition-colors">Add Admin Note</button>
        </div>
      </div>

      <div className="h-20 md:hidden"></div>
      <nav className="md:hidden fixed inset-x-0 bottom-0 z-50 flex justify-around border-t border-[#262626] bg-surface py-3">
        <a className="flex flex-col items-center gap-1 text-neutral-400" href="#"><AppIcon name="dashboard" className="lucide" /><span className="text-[10px] font-label-sm">Home</span></a>
        ...
        <a className="flex flex-col items-center gap-1 text-neutral-400" href="#"><AppIcon name="domain" className="lucide" /><span className="text-[10px] font-label-sm">Units</span></a>
        <a className="flex flex-col items-center gap-1 text-neutral-400" href="#"><AppIcon name="settings" className="lucide" /><span className="text-[10px] font-label-sm">Settings</span></a>
      </nav>
    </div>
  );
}
