...
import { Building2, CheckCircle2, Clock, List, TrendingUp, DollarSign, Users, Plus, ArrowRight, Calendar, ArrowUpRight } from 'lucide-react';
  ...
  return (
    <div className="p-6 space-y-6">
      <PageHeader
        ...
        description={`Good morning, ${userName}. You have ${pipelineStages.reduce((a, b) => a + b.count, 0)} deals in active pipeline.`}
        actions={
          <Link
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard label="Active Listings" value={String(activeListings)} trend="up" trendValue="+5" icon={List} />
      ...
      <div className="grid lg:grid-cols-3 gap-4">
        ...
        <div className="glass-card p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/dashboard/agent/schedule" className="text-xs text-emerald-400 flex items-center gap-1">
      ...
      <div className="glass-card p-5">
        <div className="flex items-center justify-between mb-5">
          ...
          <Link href="/dashboard/agent/pipeline" className="text-xs text-emerald-400 flex items-center gap-1">
        ...
        <div className="space-y-2">
          {[
            { property: 'Lekki Phase 1 Duplex', client: 'Mr. Adamu Bello', value: '₦85M', stage: 'Negotiation', probability: 75 },
            { property: 'VI Waterfront Apartment', client: 'Zenith Corp', value: '₦120M', stage: 'Due Diligence', probability: 90 },
            { property: 'Ikeja GRA Office Space', client: 'TechSolution Ltd', value: '₦45M', stage: 'Viewing Scheduled', probability: 40 },
          ].map((d, i) => (
            <div key={i} className="flex items-center gap-3 p-2.5 rounded-lg hover:bg-white/[0.025] transition-colors">
