...
export default function AgentMessagesClient({ initialConversations }: { initialConversations: Conversation[] }) {
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p style={{ color: 'var(--muted)', marginTop: 'var(--space-vs)' }}>Chat with landlords, tenants, and support</p>
        </div>
