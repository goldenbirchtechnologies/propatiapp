...
const statusConfig: Record<string, { class: string; label: string }> = {
  upcoming: { class: 'bg-[#00ff66]/10 text-[#00ff66] border border-white/[0.08]', label: 'Upcoming' },
...
function StatCardSkeleton() {
  return (
    <div className="glass-card p-4" style={{ animation: 'skel-pulse 1.6s ease-in-out infinite' }}>
      <div className="space-y-2">
        <div className="rounded" style={{ height: 11, width: '55%', background: 'border-white/[0.08]' }} />
        <div className="rounded" style={{ height: 28, width: '40%', background: 'border-white/[0.08]' }} />
      </div>
    </div>
  );
}
...
function ScheduleRowSkeleton() {
  return (
    <tr className="border-b border-white/[0.08]" style={{ animation: 'skel-pulse 1.6s ease-in-out infinite' }}>
      ...
      <td className="p-4"><div className="rounded" style={{ height: 14, width: '30%', background: 'border-white/[0.08]' }} /></td>
      <td className="p-4"><div className="rounded" style={{ height: 14, width: '30%', background: 'border-white/[0.08]' }} /></td>
      <td className="p-4"><div className="rounded" style={{ height: 22, width: 60, background: 'border-white/[0.08]', borderRadius: 999 }} /></td>
    </tr>
  );
}
        ...
        {loading ? (
            ...
            <div className="glass-card overflow-hidden">
              <div className="p-4 border-b border-white/[0.08]">
                <div className="flex gap-2">
                  <div className="rounded" style={{ height: 32, width: 80, background: 'border-white/[0.08]' }} />
                  <div className="rounded" style={{ height: 32, width: 80, background: 'border-white/[0.08]' }} />
                  <div className="rounded" style={{ height: 32, width: 80, background: 'border-white/[0.08]' }} />
                </div>
              </div>
              <table className="w-full divide-y divide-[#262626]">
                <thead>
                  <tr className="border-b border-white/[0.08]">
                    <th className="text-left p-4 text-sm font-medium text-zinc-500">Event</th>
                    <th className="text-left p-4 text-sm font-medium text-zinc-500">Date</th>
                    <th className="text-left p-4 text-sm font-medium text-zinc-500">Time</th>
          ...
          <div className="glass-card overflow-hidden">
            <div className="card-body text-center py-16">
              <CalendarDays className="w-16 h-16 mx-auto mb-4 text-zinc-500" style={{ opacity: 0.5 }} />
              <h3 className="font-headline-sm font-bold text-lg mb-2 text-white">No events scheduled</h3>
              <p className="text-xs font-label-sm uppercase tracking-wider text-zinc-500">Schedule inspections or meetings to get started.</p>
            </div>
          </div>
        ) : (
          <>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="glass-card p-4"><p className="text-xs font-label-sm uppercase tracking-wider text-zinc-500">Total Events</p><p className="text-2xl font-bold text-white">{mockSchedule.length}</p></div>
              <div className="glass-card p-4"><p className="text-xs font-label-sm uppercase tracking-wider text-zinc-500">Upcoming</p><p className="text-2xl font-bold text-white">{upcomingCount}</p></div>
              <div className="glass-card p-4"><p className="text-xs font-label-sm uppercase tracking-wider text-zinc-500">Completed</p><p className="text-2xl font-bold text-white">{completedCount}</p></div>
              <div className="glass-card p-4"><p className="text-xs font-label-sm uppercase tracking-wider text-zinc-500">Cancelled</p><p className="text-2xl font-bold text-white">{cancelledCount}</p></div>
            </div>
            <div className="glass-card overflow-hidden">
              ...
              <table className="w-full divide-y divide-[#262626]">
                <thead>
                  <tr className="border-b border-white/[0.08]">
                    <th className="text-left p-4 text-sm font-label-sm uppercase tracking-wider text-zinc-500">Event</th>
                    <th className="text-left p-4 text-sm font-label-sm uppercase tracking-wider text-zinc-500">Date</th>
                    <th className="text-left p-4 text-sm font-label-sm uppercase tracking-wider text-zinc-500">Time</th>
                    ...
                    <th className="text-left p-4 text-sm font-label-sm uppercase tracking-wider hidden md:table-cell text-zinc-500">Location</th>
                  </tr>
                </thead>
                <tbody>
                  {schedule.map((item) => {
                    ...
                    return (
                      <tr key={item.id} className="border-b transition-colors hover:bg-[#171717]/30 border-white/[0.08]">
                        <td className="p-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="min-w-0">
                              ...
                              <p className="text-xs font-label-sm uppercase tracking-wider truncate text-zinc-500">{item.listing}</p>
                            </div>
                          </div>
                        </td>
                        ...
                        <td className="p-4 text-sm hidden md:table-cell text-zinc-500">
