  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="font-headline-sm font-bold text-headline-sm text-primary">Sell Pipeline</h1>
          <p className="text-sm text-on-surface-variant mt-1">Sale agreements where you are the listing agent</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold text-warning">{stats.activeCount}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
          ...
          <CardContent>
            <p className="text-2xl font-bold text-success">{stats.closedCount}</p>
          </CardContent>
        </Card>
      </div>
        ...
        <CardContent className="p-0">
          {initialDeals.length === 0 ? (
            <div className="p-12 text-center">
              ...
              <h3 className="font-headline-sm text-headline-sm text-primary mb-2">No sell deals</h3>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-outline-variant">
                  ...
                  <th className="text-left p-4 text-sm font-medium text-on-surface-variant">Client</th>
                ...
                {initialDeals.map((d) => {
                  ...
                  return (
                    <tr key={d.id} className="border-b border-outline-variant hover:bg-surface-container-high/50 transition-colors">
                      <td className="p-4 font-medium text-sm text-primary">{d.property}</td>
