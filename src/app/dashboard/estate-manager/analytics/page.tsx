    ...
    <DashboardShell navigation={ESTATE_MANAGER_NAVIGATION} userRole="estate_manager" userName={user.fullName || 'Estate Manager'} userAvatar={user.avatarUrl || undefined}>
      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-white font-bold" style={{ fontSize: 'text-white', color: 'text-white' }}>Analytics</h1>
            <p className="text-xs text-xs uppercase tracking-wider" style={{ color: 'text-zinc-500', marginTop: 'mt-1' }}>Portfolio performance and financial insights</p>
          </div>
          ...
          <div className="card p-6">
            ...
            <div className="h-64 flex items-center justify-center border border-white/[0.08] border-dashed rounded-lg">
              <div className="text-center">
                ...
                <p className="text-xs text-xs uppercase tracking-wider" style={{ color: 'text-zinc-500' }}>Monthly collection trend</p>
          ...
          <div className="card p-6">
            ...
            <div className="h-64 flex items-center justify-center border border-white/[0.08] border-dashed rounded-lg">
              <div className="text-center">
                ...
                <p className="text-xs text-xs uppercase tracking-wider" style={{ color: 'text-zinc-500' }}>Occupancy rate trend</p>
                <p className="text-xs text-xs uppercase tracking-wider mt-1" style={{ color: 'text-zinc-500' }}>Hook chart library here</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="card p-6">
            ...
            <div className="h-64 flex items-center justify-center border border-white/[0.08] border-dashed rounded-lg">
              <div className="text-center">
                ...
                <p className="text-xs text-xs uppercase tracking-wider" style={{ color: 'text-zinc-500' }}>Unit type breakdown</p>
                <p className="text-xs text-xs uppercase tracking-wider mt-1" style={{ color: 'text-zinc-500' }}>Hook chart library here</p>
          ...
          <div className="card p-6">
            ...
            <div className="h-64 flex items-center justify-center border border-white/[0.08] border-dashed rounded-lg">
              <div className="text-center">
                <BarChart3 className="w-12 h-12 mx-auto mb-2" style={{ color: 'text-zinc-500' }} />
                <p className="text-xs text-xs uppercase tracking-wider" style={{ color: 'text-zinc-500' }}>Revenue vs expenses chart</p>
                <p className="text-xs text-xs uppercase tracking-wider mt-1" style={{ color: 'text-zinc-500' }}>Hook chart library here</p>
              </div>
            </div>
          </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-white/[0.08]">
                <th className="text-left p-4 text-sm text-xs uppercase tracking-wider" style={{ color: 'text-zinc-500' }}>Unit</th>
                <th className="text-left p-4 text-sm text-xs uppercase tracking-wider" style={{ color: 'text-zinc-500' }}>Tenant</th>
                <th className="text-right p-4 text-sm text-xs uppercase tracking-wider" style={{ color: 'text-zinc-500' }}>Amount</th>
                <th className="text-left p-4 text-sm text-xs uppercase tracking-wider" style={{ color: 'text-zinc-500' }}>Date</th>
              </tr>
            </thead>
            <tbody>
