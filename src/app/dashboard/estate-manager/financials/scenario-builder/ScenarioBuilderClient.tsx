  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="font-headline-sm font-bold" style={{ color: 'text-primary' }}>Financial Scenario Builder</h1>
              ...
              <div className="space-y-3">
                <div>
                  <div className="flex items-center gap-1.5 mb-1">
                    ...
                    <p className="text-[10px] uppercase tracking-wider text-zinc-400">Monthly Income</p>
                  </div>
                  <p className="text-xl font-bold text-success font-mono">₦{(scenario.monthlyIncome / 1e6).toFixed(2)}M</p>
                </div>
                <div>
                  <div className="flex items-center gap-1.5 mb-1">
                    <ArrowDownRight className="w-3.5 h-3.5 text-destructive" />
                    <p className="text-[10px] uppercase tracking-wider text-zinc-400">Monthly Expenses</p>
                  </div>
                ...
                <div className="pt-2 border-t border-white/5">
                  ...
                  <div className="flex items-center justify-between mt-1">
                    <p className="text-[10px] uppercase tracking-wider text-zinc-400">Margin</p>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-white/5">
                ...
                <th className="text-right p-2 text-[10px] uppercase tracking-wider text-zinc-400">Expenses</th>
                <th className="text-right p-2 text-[10px] uppercase tracking-wider text-zinc-400">Net</th>
                <th className="text-right p-2 text-[10px] uppercase tracking-wider text-zinc-400">Margin</th>
              </tr>
            </thead>
            <tbody>
              {scenarios.map((scenario) => {
                ...
                return (
                  <tr key={scenario.name} className="border-b border-white/5 transition-colors hover:bg-white/[0.02]">
                    ...
                    <td className={`p-2 text-right font-mono ${net >= 0 ? 'text-success' : 'text-destructive'}`}>
