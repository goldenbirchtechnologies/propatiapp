    ...
    <DashboardShell navigation={ESTATE_MANAGER_NAVIGATION}>
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-xl bg-primary text-on-primary p-8 md:p-10">
          <div className="max-w-2xl">
            ...
            <div className="flex gap-3">
              ...
              <button className="px-5 py-2.5 border border-text-white text-on-primary rounded-lg font-bold hover:bg-text-white/10 transition-colors">
        ...
        <div className="rounded-xl border border-[#262626] shadow-sm overflow-hidden">
          ...
          <div className="p-4 bg-surface-container rounded-lg flex items-center gap-3 border-t border-[#262626]">
        ...
        {/* Facility Contacts */}
        <div className="rounded-xl bg-primary-container text-text-white shadow-sm overflow-hidden">
