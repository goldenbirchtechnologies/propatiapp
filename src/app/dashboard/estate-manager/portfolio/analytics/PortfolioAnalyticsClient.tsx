  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Units by Status */}
        <Card className="p-6 border-white/5 bg-[#0e1726]">
            ...
            <TableBody>
              {topMaintenanceIssues.length === 0 ? (
                ...
                topMaintenanceIssues.map((issue) => (
                  <TableRow key={issue.id} className="border-white/5 transition-colors hover:bg-white/[0.02]">
                    ...
                    <TableCell className="text-sm">
                      <span className={`inline-block px-2 py-0.5 rounded-full text-[10px] border ${priorityColors[issue.priority] || 'bg-white/5 text-zinc-400 border-white/5'}`}>
                        {issue.priority}
                      </span>
                    </TableCell>
                    <TableCell className="text-sm">
                      <span className={`inline-block px-2 py-0.5 rounded-full text-[10px] border ${statusColors[issue.status] || 'bg-white/5 text-zinc-400 border-white/5'}`}>
