  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-heading font-bold" style={{ fontSize: 'var(--text-page-title)', color: 'var(--text)' }}>Buy Pipeline</h1>
          <p style={{ color: 'var(--muted)', marginTop: 'var(--space-vs)' }}>Track buyer deals across stages</p>
        </div>
