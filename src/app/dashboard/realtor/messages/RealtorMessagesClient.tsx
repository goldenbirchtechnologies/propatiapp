...
export default function RealtorMessagesClient({ initialConversations }: { initialConversations: Conversation[] }) {
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p style={{ color: 'var(--muted)', marginTop: 'var(--space-vs)' }}>Chat with buyers, sellers, and support</p>
        </div>
      ...
      <div className="card overflow-hidden">
        ...
        {filtered.length === 0 ? (
          <div className="card-body text-center py-16">
            ...
            <p style={{ color: 'var(--muted)' }}>Start a new conversation.</p>
          </div>
        ) : (
          <div>
            {filtered.map((conv) => (
