  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-heading font-bold text-headline-sm text-primary" >Sell Pipeline</h1>
          <p className="text-on-surface-variant mt-1">Track seller deals across stages</p>
        </div>
