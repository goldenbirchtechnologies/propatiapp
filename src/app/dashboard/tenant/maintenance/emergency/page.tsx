  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        ...
        <div className="glass-card">
          <div className="p-6 pt-6">
            <p className="text-sm text-zinc-500">This page was ported from the reference design: <strong>refined_emergency_hotline_state_propati_maintenance.html</strong></p>
          </div>
        </div>
      </div>
