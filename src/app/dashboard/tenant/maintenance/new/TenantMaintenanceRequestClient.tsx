            ...
            <CardContent className="p-6 md:p-8">
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label className="font-bold text-white text-sm">Issue Category</Label>
                      <select
                        value={category}
                    ...
                    <div className="space-y-2">
                      <Label className="font-bold text-white text-sm">Urgency Level</Label>
                  ...
                  <div className="space-y-2">
                    <Label className="font-bold text-white text-sm">Description of the issue</Label>
                    <Textarea
              ...
              {step === 2 && (
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <Label className="font-bold text-white text-sm">Preferred Availability</Label>
