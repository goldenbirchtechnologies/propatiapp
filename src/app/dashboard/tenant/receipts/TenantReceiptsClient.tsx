...
export default function TenantReceiptsClient({ initialReceipts }: { initialReceipts: Receipt[] }) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-headline-sm" className="text-primary" style={{ fontSize: 'var(--text-page-title)' }}>Receipts</h1>
      ...
      <div className="card overflow-hidden">
        ...
        {filtered.length === 0 ? (
          <div className="card-body text-center py-16">
            <Receipt className="w-16 h-16 mx-auto mb-4" className="text-on-surface-variant" style={{ opacity: 0.5 }} />
