    ...
    <section className="container mx-auto py-12">
      <div className="space-y-6">
        <section className="rounded-2xl border border-white/[0.08] bg-card p-6 shadow-none">
          ...
          <p className="text-zinc-500 mt-1">EstateVerify - Verification Wizard EstateVerify Rent Buy Short-let notifications check Identity check Ownership check L3 Virtual 04 L4 Physical Verify...</p>
        </section>
        <section className="rounded-xl border border-white/[0.08] bg-background p-5">
          ...
          <p className="text-zinc-500">Final Verification Step</p>
        </section>
        <Card>
          <CardContent className="pt-6">
            <p className="text-sm text-zinc-500">Ported from reference: <strong>property_verification_step_4_inspection_propati.html</strong></p>
          </CardContent>
        </Card>
      </div>
    </section>
