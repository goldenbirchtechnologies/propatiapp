...
export default function SearchFilters({
  ...
  return (
    <div className="bg-surface-elevated rounded-lg shadow-sm border border-zinc-800 p-6 space-y-6">
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          {showLocationDropdown && filteredLocations.length > 0 && (
            <div className="absolute z-10 w-full mt-1 bg-surface-elevated border border-zinc-800 rounded-lg shadow-lg max-h-60 overflow-y-auto">
